...
QA_PAIRS = {
    ...
    # ===== Адмінка =====
    r"\b(хочу|як|дайте|модераторка|модерку|отримати|коли|чи можна|де|візьміть|можна|заявка|кастинг|відбір|набір|прийміть).*(адмінк|адміністратор|адміном|модер|модерувати|в адміни)\b":
